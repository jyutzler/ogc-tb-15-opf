...
Internal reference number of this OGC® document: TBD +
Version: 0.0.1 +
Category: OGC® Encoding Standard +
Editor:   Jeff Yutzler

[title]
= OGC® GeoPackage Vector Tiles Extension =
...
Document type:         	OGC® Draft GeoPackage Extension +
...
This draft OGC® Encoding Standard defines a GeoPackage Extensions for vector tiles.

== Keywords ==

ogcdoc, geopackage, sqlite, raster, vector, feature, attributes, data, storage, exchange, mobile, smartphone, tablet, media
